...
public class MyAlerts {
    ...
    public static Button getDeleteBtn(){
        ...
        btnDelete.setStyle("-fx-font-size: 12px;-fx-background-color: red;-fx-text-fill: white");
        btnDelete.setCursor(Cursor.HAND);
        return btnDelete;
    }
    public static Button getEditBtn(){
        Button btnEdit=new Button("Edit");
        btnEdit.setStyle("-fx-font-size: 12px;-fx-background-color: blue;-fx-text-fill: white");
